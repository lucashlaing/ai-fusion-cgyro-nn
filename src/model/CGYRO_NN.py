...
class CGYRO_NN(Base):
    ...
    def __init__(self, cfg, lowerModel):
        super(CGYRO_NN, self).__init__(cfg)
        self.cfg = cfg
    ...
    def report_stats(self):
        super(CGYRO_NN, self).report_stats()
    ...
    def forward(self, input):
        ...
        # predictions from the lower fidelity model
        lower_pred_per_ky = self.lowerModel(input)
        combined_pred_per_ky = pred_per_ky + lower_pred_per_ky

        return combined_pred_per_ky
