...
class Spectra_Regularization_Trainer(Base_Trainer):
    def __init__(self, model, model_cfg, opt_cfg, dataset_cfg, tc_rng=None):
        super().__init__(model, model_cfg, opt_cfg, dataset_cfg, tc_rng)
